...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "INSERT INTO users_new (username, password, fullname, created_at) VALUES (?, ?, ?, NOW())";
...
<head>
    ...
    <title>Sign Up E-Visit BPRS HIK MCI</title>
...
<body>
    <div class="content">
        ...
        <div class="text">Signup <span style="color:green">E-Visit</span></div>
